pipeline {
    ...
    environment {
        NETLIFY_SITE_ID = '23203143-7677-49eb-8eb8-5e18d29db9a3'
    ...
    stages {
        ...
        stage('AWS') {
            ...
            environment {
                AWS_S3_BUCKET = 'learn-jenkins-202508171020'
            }
            steps {
        ...
        stage('Deploy prod') {
            ...
            environment {
                CI_ENVIRONMENT_URL = 'https://adorable-valkyrie-e208bd.netlify.app'
            }
            steps {
                sh '''
                    netlify --version
